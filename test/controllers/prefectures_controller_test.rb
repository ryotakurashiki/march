...
class PrefecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prefecture" do
    assert_difference('Prefecture.count') do
      post prefectures_url, params: { prefecture: { area: @prefecture.area, name: @prefecture.name } }
    end
  ...
  test "should update prefecture" do
    patch prefecture_url(@prefecture), params: { prefecture: { area: @prefecture.area, name: @prefecture.name } }
